...
?>
    ...
    <div class="row">
        <div class="col-sm">
            <div class="input-group mb-3">
                <span class="input-group-text feather-file-text" id="basic-addon2"></span>
                <input type="textarea" id="pedi-observ" name="pedi-observ" readonly class="form-control" placeholder="Observaciones del pedido" aria-label="Productos" aria-describedby="basic-addon2" value='<?php echo $orderHeader["PEDI_OBSERVACION"]; ?>'>    
            </div>
        </div>
    </div>    
