<?php
    ...
    class csOrder extends connectDB{
        ...
        public function UpdateOrderTrxSP($empresa_id, $nOrder, $nNotaventa, $items){ 
            ...
            $query = "CALL UpdateOrder($empresa_id, $nOrder, $nNotaventa, $items)";
        ...
        public function UpdateOrderTrx($empresa_id, $nOrder, $nNotaventa, $items){ 
            try
            {
                $queries = array();
                $data = array();
                ...
                array_push($queries,"UPDATE fa_pedido SET PEDI_ENVIADO = 'N', PEDI_ALFA = ? WHERE PEDI_CODIGO_PEDIDO = ? AND PEDI_CODIGO_EMPRESA = ?");
    
                //prepare data
                array_push($data,[$nNotaventa, $nOrder, $empresa_id]); 
        ...
        public function UpdateAproveOrderTrx($empresa_id, $nOrder, $nNotaventa, $sObserv, $sEstado, $items){ 
            try
            {
                $queries = array();
                $data = array();
                ...
                //Prepare queries update fa_pedido
                array_push($queries,"UPDATE fa_pedido SET PEDI_ENVIADO = ?, PEDI_ALFA = ?, PEDI_OBSERVACION = ?  WHERE PEDI_CODIGO_PEDIDO = ? AND PEDI_CODIGO_EMPRESA = ?");
    
                //prepare data
                array_push($data,[$sEstado, $nNotaventa, $sObserv, $nOrder, $empresa_id]); 
