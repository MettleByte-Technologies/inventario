<?php
    ...
    class csOrder extends connectDB{
        ...
        public function UpdateOrderTrx($empresa_id, $nOrder, $nNotaventa, $items, $bodega){ 
            try
            {
                $queries = array();
                $data = array();
                ...
                array_push($queries,"UPDATE fa_pedido SET PEDI_ENVIADO = 'N', PEDI_ALFA = ?, PEDI_CODIGO_BODEGA = ? WHERE PEDI_CODIGO_PEDIDO = ? AND PEDI_CODIGO_EMPRESA = ?");
    
                //prepare data
                array_push($data,[$nNotaventa, $bodega, $nOrder, $empresa_id]); 
