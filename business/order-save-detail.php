<?php
    ...
    if (isset($_POST['nOrder']) && isset($_POST['vend_codigo']) && isset($_POST['vend_empresa']) && isset($_POST['client']) && isset($_POST['order'])  && isset($_POST['action']))
    {
        ...
        */
        ...
        if ($empresa_id == '2') $bodega = '7';
        //if ($bodega != '1' && $bodega != '2') $bodega = '7';
        ...
        switch ($action){
            ...
            case "update-order":
                ...
                echo $obj->UpdateOrderTrx( $empresa_id, $noOrder, $notaventa, $items, $bodega, $order_observ);
                //echo $bodega;
                //echo $_POST['bodega'];//$bodega;
