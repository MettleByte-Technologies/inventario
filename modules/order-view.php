...
?>
<input type="hidden" id="data-estado" name="data-estado" value="<?php echo $estado; ?>"/>
<input type="hidden" id="data-exportada" name="data-exportada" value="<?php echo $orderHeader['PEDI_EXPORTADA']; ?>"/>
<div class="container">
    <script>
    ...
    <input type="hidden" id="data-NotaVenta" name="data-NotaVenta" value="<?php echo "0";//$orderHeader["PEDI_ALFA"]; ?>"/>
    <div class="cliente-data">    
        ...
        <div class="row">
            <div class="col-sm-2">
                <label for="CODIGO">CODIGO VENDEDOR</label>
            </div>
            <div class="col-sm-10">
                <label class="form-control-sm" ><?php echo $vend_codigo; ?></label>
                <input type="hidden" id="vend-id" name="vend-id" value="<?php echo $vend_codigo; ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <input type="hidden" id="client-name" name="client-name" value="<?php echo $clientObj["NOMBRE"]; ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
        ...
        <!--<div class="row">
            ...
            <div class="col-sm-10">
                <label class="form-control-sm"><?php echo $orderHeader["PEDI_CODIGO_BODEGA"]; ?></label>
            </div>
        </div>-->
    </div>
...
?>
    ...
    <div class="col-sm">
        <div class="input-group mb-3">
            ...
            <select id="select-bodega" class="form-select form-select-sm" aria-label=".form-select-sm example">
            <option value="6" <?php if ($orderHeader["PEDI_CODIGO_BODEGA"] == 6) echo "selected"; ?>>6</option>
            <option value="7" <?php if ($orderHeader["PEDI_CODIGO_BODEGA"] == 7) echo "selected"; ?>>7</option>
            </select>
        </div>
    </div>    
    <div class="row">
        ...
        <div class="col-sm-2">        
            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Deuda">
    ...
    <div class="alert alert-primary alert-dismissable" id="notaventa-alert">
        <strong>¡Se requiere!</strong> Nota de Venta.
    </div>    
    ...
    <div class="row totales">
        ...
        <div class="col-sm">
            <b>Cantidad:</b> <label id="total-items"><?php echo number_format($orderHeader["PEDI_VALOR_PEDIDO"], 2); ?></label>
        </div>
        <div class="col-sm">
            <b>Descuento:</b> <label id="total-dscto"><?php echo number_format($orderHeader["PEDI_DESCUENTO_TOTAL"],2); ?></label>
        </div>
        <div class="col-sm">
            <b>A pagar:</b> <label id="total-pagar"><?php echo number_format($orderHeader["PEDI_PRECIO_VTA"],2); ?></label>
        </div>
    ...
    <!--<div class="row">
        <div class="col-sm">
            <div class="input-group mb-3">
                ...
                <input type="text" id="observ" name="observ" class="form-control" placeholder="Observaciones del pedido" aria-label="Productos" aria-describedby="basic-addon2">    
            </div>
        </div>
    </div>    -->
    ...
    <div class="row">
        <div class="col-sm">
            <div class="input-group mb-3">
                <span class="input-group-text feather-file-text" id="basic-addon2"></span>
                <input type="textarea" id="pedi-observ" name="pedi-observ" class="form-control" placeholder="Observaciones del pedido" aria-label="Productos" aria-describedby="basic-addon2" value='<?php echo $orderHeader["PEDI_OBSERVACION"]; ?>'>    
            </div>
        </div>
    </div>    
...
<script type="text/javascript" src="../js/fs/FileSaver.min.js"></script>
<script type="text/javascript" src="../js/dist-edit/jquery.jeditable.min.js"></script>
