      ...
      buttons: [
        {
          ...
          action: function (e, dt, node, config) {
            ...
            //console.log($("#select-bodega").find("option:selected").val());
            console.log(
                  ...
                  case 0:
                    ...
                    if (nitems > 1)
                      ...
                      alertMsg(
                        ...
                        id_message_obj,
                        "Item eliminado",
                        "Items " + itemsList + " fueron actualizados"
                      );
                    //$("#message").html("Item " + itemsList + " fue actualizado");
                      ...
                      alertMsg(
                        ...
                        id_message_obj,
                        "Item eliminado",
                        "Item " + itemsList + " fue actualizado"
                      );
