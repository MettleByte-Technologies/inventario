             ...
             buttons: [
                   {
                      ...
                      action: function ( e, dt, node, config ) {
                        ...
                        order_det += "]";
                        console.log(order_det);
                        console.log('Observaciones: ' + $("input[name='pedi-observ']").val());
                        console.log('Nota Venta: ' + $("input[name='notaventa']").prop("checked"));
                        ...
                        /************************************ */                           
                         ...
                         $.ajax({
                            ...
                            data: {nOrder:$("#nOrder").val(),
                                   ...
                                   order: order_det,
                                   orderh: $("input[name='pedi-observ']").val(),
                                   action: "update-order",
                            ...
                            success: function(resp) {
                                ...
                                $.ajax({
                                   ...
                                   success: function(resp) {  
                                      ...
                                      {
                                      $("#title-content").html("<h2>Pedidos</h2> Order procesada");  
                                      $("#content").html(resp);  
