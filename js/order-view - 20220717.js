             ...
             buttons: [
                   {
                      ...
                      action: function ( e, dt, node, config ) {
                         ...
                         for (let i = 0; i < rows.length; i++) {
                            ...
                            */
                           var str = rows[i][11];
                          // var stringToHTML = getTagHtmlFromString(str);
                           
                           //console.log(stringToHTML);
                           //console.log(stringToHTML.getElementsByTagName('txt-observ'));
                           //console.log(rows[i].getElementsByTagName('txt-observ'));
                           
                           //var cant = rows[i].find('#txt-observ').val();
                           //console.log(rows[i]);
                           //prod = "'" + rows[i][0];
                            //qty = rows[i][3];
...
console.log(rowsT);
 ...
 /************************************ */  
                     ...
                     action: function ( e, dt, node, config ) {
                        ...
                        $.ajax({
                            ...
                            data: {action:"reprove-order",
                                ...
                                deuda: ($("input[name='deuda']").prop("checked") == true  ? 1 : 0)},
                  ...
                  {
                    text: '<b>Export Oracle (Aprobar)</b>',
                    action: function ( e, dt, node, config ) {
