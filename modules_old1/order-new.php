    ...
    <div class="row">
        <div class="col-sm">
            <div class="input-group mb-3">
                ...
                <input type="text" id="pedi-observ" name="pedi-observ" readonly class="form-control" placeholder="Observaciones del pedido" aria-label="Productos" aria-describedby="basic-addon2">    
            </div>
        </div>
    </div>
