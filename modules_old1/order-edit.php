    ...
    <div class="row">
        <div class="col-sm">
            <div class="input-group mb-3">
                ...
                <input type="text" id="pedi-observ" name="pedi-observ" class="form-control" readonly placeholder="Observaciones del pedido" aria-label="Productos" aria-describedby="basic-addon2" value='<?php echo $orderHeader["PEDI_OBSERVACION"]; ?>'>    
            </div>
        </div>
    </div>    
